...
const showProfile = async (req, res) => {
    const user = await User.findOne({username: "bruce_angry"}).select('-password -refreshToken -__v ');
    console.log(user);
...
export {registerUser, loginUser, logoutUser, refreshAcessToken, showProfile};